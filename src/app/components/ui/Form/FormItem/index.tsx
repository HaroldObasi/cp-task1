...
const index = (props: Props) => {
  ...
  return (
    <div className="pb-[25px] border-b mb-[23px] flex flex-col sm:flex-row sm:justify-between sm:items-center border-[#C4C4C4]">
      <p className="font-semibold text-[18px] sm:text-xl">
        {props.name}{" "}
        <span className=" text-[12px] sm:text-[15px]">{props.subText}</span>
      </p>
      <div className="flex flex-row justify-between md:gap-x-10">
